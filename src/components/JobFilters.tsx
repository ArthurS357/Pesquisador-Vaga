...
export function JobFilters({ current, sources, lenses }: Props) {
  ...
  return (
    <div className={`filters-grid${pending ? " filters-grid-pending" : ""}`} aria-busy={pending}>
      ...
      <fieldset className="field field-fonte">
      ...
      <fieldset className="field field-lens">
      ...
      <div className="field field-score">
        <label className="label" htmlFor="min-score">
          Score mínimo: <span className="label-val">{min}</span>
        </label>
